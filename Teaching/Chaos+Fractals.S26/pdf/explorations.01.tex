...
\bigskip
    {{\bf Do these before class on Thursday, April 9, 2026}}\\ 
\end{center}
\medskip
...
\item Do this with others if you like. It might be more fun that
  way.
\item We'll go over this in class. There's nothing to hand in, but
  take some notes (words and/or pictures) as you explore.
